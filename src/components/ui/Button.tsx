...
const buttonVariants = cva(
  ...
  [
    ...
    'focus-visible:ring-2 focus-visible:ring-[color:var(--theme-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-cream',
    // Disabled
    ...
    variants: {
      variant: {
        ...
        primary: [
          ...
          'shadow-[0_1px_2px_rgba(47,33,27,0.12),0_12px_30px_rgba(47,33,27,0.12)]',
          'hover:bg-[color:var(--accent-strong)] hover:shadow-[0_1px_3px_rgba(47,33,27,0.14),0_16px_36px_rgba(47,33,27,0.14)]',
          'active:shadow-[0_1px_2px_rgba(47,33,27,0.1)]',
        ],
        ...
        outline: [
          'bg-transparent text-[color:var(--accent)] border-2 border-[color:var(--accent-soft)]',
          'hover:bg-[color:var(--accent-soft)] hover:border-[color:var(--accent)]',
