          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              style={{
                ...
                border: `1px solid ${activeFilters ? "rgba(232,57,14,0.3)" : "rgba(255,255,255,0.09)"}`,
              }}
            >
              <SlidersHorizontal
                className="h-4 w-4"
                style={{
                  color: activeFilters ? "#E8390E" : "rgba(254,243,226,0.6)",
                }}
              />
              {activeFilters && (
                <span className="absolute -right-1 -top-1 h-2.5 w-2.5 rounded-full bg-pepper" />
              )}
            </button>
          </div>
        }
