        ...
        <div className="mb-8">
          <div className="mb-6 flex gap-1">
            {[1, 2, 3].map((s) => (
              <div
                key={s}
                className={`h-1 flex-1 rounded-full ${s <= 2 ? 'bg-pepper' : 'bg-coal'}`}
              />
            ))}
          </div>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-1 text-xs text-ember transition-all hover:text-ember/80 disabled:opacity-40"
              >
            ...
            <textarea
              ...
              className="w-full resize-none rounded-lg border border-white/10 bg-coal px-3 py-2.5 text-sm text-cream outline-none placeholder:text-mist focus:border-pepper"
            />
          </div>
