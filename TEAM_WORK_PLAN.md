...
*   **Assigned to: Katura (Franklin.I)**
    *   [ ] Generate Supabase types via `supabase gen types typescript` and commit.
        *   *Note:* This task is independent, foundational, and crucial for overall type safety. It will generate `src/types/db.ts` with updated types based on the Supabase schema.
